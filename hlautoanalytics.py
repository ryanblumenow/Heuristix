    ...
    def run(self):
        ...
        if value=='EDA':
            ...
            with st.spinner('Please wait while we set up the dimension reduction'):
                ...
                # Upload dataset
                st.title("Data Analysis and Dimension Reduction Tool")
            ...
            # Upload dataset
            st.title("Data Analysis, Regression, and Clustering Tool")
            uploaded_file = st.file_uploader("Upload your dataset (CSV file)", type=["csv"])
            ...
            with st.spinner('Please wait while we conduct the conjoint analysis'):
                ...
                st.info("Conjoint analysis is traditionally a method for determining what features of a product are most important to consumers. We extend the usage here to enable us to determine what factors are most important in determining a individuals's outcomes related to a chosen variable.")

                # Upload dataset
                st.title("Dynamic Analysis Tool")
                uploaded_file = st.file_uploader("Upload your dataset (CSV file)", type=["csv"])
        ...
        - __"""
            ...
            with st.spinner('Please wait while we conduct the decision tree analysis'):
                ...
                st.info("A decision tree is a decision support tool that uses a tree-like model of decisions and their possible consequences, including chance event outcomes, resource costs, and utility.")

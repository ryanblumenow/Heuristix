...
def alisen():
    ...
    st.write("This is decision support: artifically intelligent advanced domain expertise and organizational knowledge, trained on and sourced from your data.")
    ...
    with alisencolm2:
        alisen = st.image('alisen3.jpg', width=600)
